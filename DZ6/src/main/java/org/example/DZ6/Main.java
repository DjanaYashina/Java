...
public class Main {
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("Asus", "4", "256", "Windows", "grey");
        Notebook notebook2 = new Notebook("Asus", "4", "512", "Linux", "black");
        Notebook notebook3 = new Notebook("Asus", "8", "1024", "Windows", "black");
        Notebook notebook4 = new Notebook("Asus", "16", "1000", "Windows", "grey");
        Notebook notebook5 = new Notebook("HP", "4", "512", "Windows", "grey");
        Notebook notebook6 = new Notebook("Huawei", "4", "512", "Linux", "black");
        Notebook notebook7 = new Notebook("Huawei", "8", "256", "Windows", "black");
        Notebook notebook8 = new Notebook("Lenovo", "4", "256", "Linux", "black");
        Notebook notebook9 = new Notebook("Lenovo", "8", "512", "Windows", "grey");
        Notebook notebook10 = new Notebook("Lenovo", "16", "1024", "Windows", "grey");

        Set<Notebook> notebooks = new HashSet<>(List.of(notebook1, notebook2,
                notebook3, notebook4, notebook5, notebook6, notebook7, notebook8, notebook9, notebook10));
    ...
    public static Map<String, String> selectCriteria() {
        ...
        while (true) {
            System.out.println("Вы хотите выбрать критерий для поиска параметров ноутбука? Если да введите 'y', если нет введите 'n'");
